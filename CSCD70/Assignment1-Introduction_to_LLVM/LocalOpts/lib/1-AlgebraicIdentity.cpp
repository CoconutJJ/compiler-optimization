...
bool AlgebraicIdentityPass::algebraicIdentity (llvm::Instruction &I)
{
        ...
        case Instruction::Add:
                ...
                if (isa<ConstantInt> (Op1) && isa<ConstantInt> (Op2)) {
                        I.replaceAllUsesWith (ConstantInt::getSigned (I.getType (), Op1Const + Op2Const));
...
PreservedAnalyses AlgebraicIdentityPass::run ([[maybe_unused]] Function &F, FunctionAnalysisManager &)
{
